...
bool DownloadThread::_openAndPrepareDevice()
{
    ...
    if (authopenresult == _file.authOpenCancelled) {
        ...
        msg += "<br>"+tr("Please verify if 'AliroEd Imager' is allowed access to 'removable volumes' in privacy settings (under 'files and folders' or alternatively give it 'full disk access').");
